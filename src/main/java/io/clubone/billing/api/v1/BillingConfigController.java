...
public class BillingConfigController {
    ...
    public ResponseEntity<BillingProfileLookupsResponse> getBillingProfileLookups(HttpServletRequest request) {
        var applicationId = ApplicationIdHeader.requireApplicationId(request);
